    ...
    return (
        <div className="container mt-4 p-1 pb-2" id="FondoMegatop" style={{ backgroundColor: "#013047", borderRadius: "10px" }}>
            <div className="d-flex justify-content-between">
                ...
                <i onClick={() => SetModoEdicion(true)} style={{ cursor: "pointer" }} className="fa-solid fa-gear" />
            </div>
                ...
                {ModoEdicion &&
                    <div className="row m-0 d-flex justify-content-around">
                        ...
                        <div className="mt-2 d-flex justify-content-center">
                            <button type="button" className="btn btn-outline-primary btn-lg">Guardar Cambios</button>
                        </div>
                    </div>
                }
            </div>
